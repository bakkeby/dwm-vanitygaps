...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_s,      setflexlayout,  {.i =   6 } }, // monocle
	{ MODKEY|ControlMask,           XK_d,      setflexlayout,  {.i =   7 } }, // grid
	{ MODKEY|ControlMask,           XK_f,      setflexlayout,  {.i = 261 } }, // default tile (also default)
